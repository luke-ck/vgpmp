...
from gpflow_vgpmp.inducing_variables.inducing_variables import (ConditionedSeparateIndependentInducingVariables,
                                                                ConditionedSharedIndependentInducingVariables,
                                                                ConditionedVelocitySharedIndependentInducingVariables)
...
@Kuu.register(FallbackSharedIndependentInducingVariables,
              (FirstOrderKernelDerivativeSeparateIndependent, IndependentLatent))
def kuu_fallback_shared_separate_derivative(
...
def kuu_fallback_shared_separate_vanilla(
    ...
    Kmm = K_conditioned(inducing_variable.inducing_variable.Zy,
                        inducing_variable.inducing_variable.Zy, kernel)
    jittermat = tf.eye(inducing_variable.num_inducing + inducing_variable.inducing_variable.ny.shape[0],
...
@Kuu.register(FallbackSeparateIndependentInducingVariables,
              (FirstOrderKernelDerivativeSeparateIndependent, IndependentLatent))
def kuu_fallback_separate_separate_derivative(
        inducing_variable: ConditionedSharedIndependentInducingVariables,
        kernel: Union[FirstOrderKernelDerivativeSeparateIndependent, IndependentLatent],
        *,
        jitter: float = 0.0,
...
def kuu_fallback_separate_separate(
        inducing_variable: FallbackSharedIndependentInducingVariables,
        kernel: Union[VanillaConditioningSeparateIndependent, IndependentLatent],
        *,
        jitter: float = 0.0,
) -> tf.Tensor:
    Kmm = K_conditioned(inducing_variable.inducing_variable_list, kernel)

    jittermat = tf.eye(inducing_variable.num_inducing + inducing_variable.inducing_variable_list[0].ny.shape[0],
                       dtype=Kmm.dtype)[None, :, :] * jitter
