...
@magic_Kuu.register(InducingPoints, Kernel)
def magic_K_fallback(inducing_variable: InducingPoints, kernel: Kernel):
...
@magic_Kuf.register(InducingPoints, Kernel, TensorLike)
def magic_K_fallback(inducing_variable: InducingPoints, kernel: Kernel, Xnew):
