...
class Problemset(AbstractProblemset, ABC):
    ...
    def states(problemset):
        if problemset == "bookshelves":
            ...
            states[2] = [-0.57713206, -1.08671742, 0.9299246,5 -2.06242551, -1.25622074, 0.2231967 ]
            ...
            states[8] = [-1.9249775378636007, -1.8529688610900832, 1.299, -1.349581889702728, -1.5628525836094842, -0.13960430892749198]
    ...
    def planner_params(problemset):
        if problemset == "industrial":
            return {
                "sigma_obs": 0.0001,
                "epsilon": 0.08,
                "lengthscales": [600, 600, 600, 600, 600, 600],
                "variance": 0.1,
                "alpha": 100,
                "num_samples": 7,
                "num_inducing": 18,
            ...
            return {
                "sigma_obs": 0.002, # 0.05
                "epsilon": 0.03,
                "lengthscales": [400] * 6, #[500, 500, 500, 500, 500, 500],
                "variance": 0.05,
                "alpha": 100.0,
                "num_samples": 7,
                "num_inducing": 10,
