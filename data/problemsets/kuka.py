...
class Problemset(AbstractProblemset, ABC):
    ...
    def states(problemset):
        if problemset == "bookshelves":
            ...
            states[2] = [-1.04673182, 0.68041032, 0.63478252, -0.64227376, -2.96705973, -1.07312957, 0.96852192]
            ...
            states[5] = [0.7185098, 1.5467082, 1.59868419, 0.48303008, -2.96705973, -0.89603846, 2.68993638]
    ...
    def planner_params(problemset):
        if problemset == "industrial":
            return {
                "sigma_obs": 0.005,
                "epsilon": 0.04,
                "lengthscales": [200.0, 200.0, 100.0, 50.0, 100.0, 100.0, 100.0],
                "variance": 0.05,
                "alpha": 25,
                "num_samples": 7,
                "num_inducing": 7,
